$(document).ready(function(){ // после загрузки DOM
	$('#gform-jquery-php').submit(function(e){ // вешаем событие на отправку формы
		...
		$.ajax({ // инициализируем аякс
            url: "send-g-form.php", // путь до нашего php обработчика, в моем случае он лежит в той же папке что и форма
